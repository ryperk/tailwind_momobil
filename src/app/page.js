...
export default function Page() {
  ...
  return (
    <div className="">
      <Header />
      {/* <div id="header" className="bg-gray-100 border-b px-4 border-gray-200">
        <div className="flex min-h-[70] max-w-7xl mx-auto bg-gray-200">
            ...
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
                  A better workflow - Product Overview Sample !!!!!
                </p>
